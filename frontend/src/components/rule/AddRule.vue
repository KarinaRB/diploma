    ...
    <div id="content">
        ...
        <div v-if="!submitted">
            ...
            <form @submit="addRule">
                ...
                <textarea name="grammar" placeholder="Правила вида S ::= a" required v-model="rule.grammar" class="form-control mt-2"></textarea>
        ...
        methods:{
            ...
            getTable(rules){
                ...
                rules.forEach(element=>{
                    ...
                    if(rpart[0] != this.rule.endSymbol){
                        elements = this.getFirstOfRule(rpart);
                    }
                    ...
                    elements.forEach(el=>{
                        this.MTable.set(element[0] + el, [rpart, i]);
                    });
                    i++;
                });
